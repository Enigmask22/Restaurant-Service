...
class AwsS3Service
{
    ...
    public function __construct()
    {
        $this->s3Client = new S3Client([
            ...
            'version' => 'latest',
            'credentials' => [
                'key' => EnvHelper::getEnv('YOUR_AWS_ACCESS_KEY'), // Thay bằng Access Key của bạn
                'secret' => EnvHelper::getEnv('YOUR_AWS_SECRET_KEY'), // Thay bằng Secret Key của bạn
            ]
        ]);

        $this->bucketName = EnvHelper::getEnv('BUCKET_NAME'); // Thay bằng tên bucket của bạn
    }
    ...
    public function uploadFile($file, $folder)
    {
        ...
        // Xóa hoặc comment dòng var_dump này
        // var_dump([

...
class RestaurantModel {
    ...
    public function updateRestaurant(
        ...
        $query_restaurant = "UPDATE restaurant SET `restaurant_name`='$restaurant_name', `adult_price`='$adult_price', `child_price`='$child_price', `address`='$address', `open_time`='$open_time', `description`='$description', `res_include`='$res_include', `res_exclude`='$res_exclude', `res_condition`='$res_condition', `res_rate`='$res_rate' WHERE `rid`='$rid'";

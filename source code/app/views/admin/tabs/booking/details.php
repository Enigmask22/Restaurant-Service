...
<form action="<?php echo $path; ?>admin/booking/updateStatus/<?php echo $data['booking']->bid ?>" method="post" class="max-w-[1500px] mx-auto space-y-8 p-6 bg-white shadow-md rounded-lg dark:bg-gray-800 dark:text-white">
    ...
    <div class="flex justify-end mt-8 space-x-4">
        ...
        <a href="<?php echo $path; ?>admin/booking/restaurant_detail/<?php echo $data['booking']->r_id ?>" class="px-6 py-3 font-semibold text-white transition duration-300 ease-in-out transform bg-indigo-500 border border-indigo-500 rounded-lg shadow-md hover:bg-indigo-600 hover:scale-110 hover:shadow-lg focus:outline-none">
            Quay lại
        </a>
    </div>
</form>

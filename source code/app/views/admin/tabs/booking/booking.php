            ...
            <?php if ($data['bookings'])
                foreach ($data['bookings'] as $booking) { ?>
                    <tr
                        ...
                        <td
                            class="overflow-x-hidden px-6 py-4 max-w-xs text-gray-900 overflow-ellipsis whitespace-nowrap dark:text-gray-200">
                            <?php echo $booking->phone ?>
                        </td>
                        <td class="overflow-x-hidden px-6 py-4 max-w-xs overflow-ellipsis whitespace-nowrap">
                            <span

...
<div class="overflow-x-auto relative p-6 mx-auto max-w-[1500px] bg-white shadow-md sm:rounded-lg dark:bg-gray-800">
    ...
    <form method="GET" action="<?php echo $path ?>restaurant/booking"
        class="p-4 mb-6 rounded-lg bg-gray-50 dark:bg-gray-700">
            ...
            <tr
                ...
                <td class="px-6 py-4">
                    <div class="flex justify-end space-x-2">
                        <a href="<?php echo $path ?>restaurant/booking/details/<?php echo $booking->bid ?>"
                        ...
                        <a href="<?php echo $path ?>restaurant/booking/deleteBooking/<?php echo $booking->bid ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const deleteButtons = document.querySelectorAll('.booking-delete-btn');

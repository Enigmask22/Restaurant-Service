...
<form action="<?php echo $path; ?>restaurant/booking/updateStatus/<?php echo $data['booking']->bid ?>" method="post"
    class="max-w-[1500px] mx-auto space-y-8 p-6 bg-white shadow-md rounded-lg dark:bg-gray-800 dark:text-white">
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <!-- Phản hồi trạng thái -->
        <div class="flex items-center">
            <label for="status" class="w-1/4 text-lg font-medium text-gray-900 dark:text-white">Thay đổi trạng
                thái</label>
    ...
    <div class="flex justify-end mt-8 space-x-4">
        <button name="confirmSubmit" type="submit"
            class="px-6 py-3 font-semibold text-white transition duration-300 ease-in-out transform bg-teal-500 border border-teal-500 rounded-lg shadow-md hover:bg-teal-600 hover:scale-110 hover:shadow-lg focus:outline-none">Lưu
            thay đổi</button>
        <a href="<?php echo $path; ?>restaurant/booking"
